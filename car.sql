...
The idea is to create an online system to help him search for cars and various attributes. Your role is to design and implement the relational database for his agency (The implementation of the software is not required).
